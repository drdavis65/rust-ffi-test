...
for.body.prol:                                    ; preds = %for.body.preheader28
  ...
  %6 = load <2 x float>, ptr %arrayidx.prol, align 4, !tbaa !5
  %7 = load <2 x float>, ptr %arrayidx1.prol, align 4, !tbaa !5
  ...
  store <2 x float> %10, ptr %arrayidx1.prol, align 4, !tbaa !5
