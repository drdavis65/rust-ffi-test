; *** IR Dump After PromotePass on axpy_pts_restricted ***
; Function Attrs: nounwind uwtable
define dso_local void @axpy_pts_restricted(i64 noundef %n, ptr noalias noundef %dst, ptr noalias noundef %src, float noundef %alpha) local_unnamed_addr #0 {
entry:
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  %y = getelementptr inbounds nuw %struct.Pt, ptr %arrayidx, i32 0, i32 1
  %3 = load float, ptr %y, align 4, !tbaa !15
  %y5 = getelementptr inbounds nuw %struct.Pt, ptr %arrayidx1, i32 0, i32 1
