; *** IR Dump After LoopLoadEliminationPass on axpy_pts_restricted ***
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %interleaved.vec = shufflevector <8 x float> %4, <8 x float> poison, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
...
for.body:                                         ; preds = %scalar.ph, %for.body
  ...
  %6 = load float, ptr %arrayidx, align 4, !tbaa !20
  %arrayidx1 = getelementptr inbounds nuw %struct.Pt, ptr %dst, i64 %i.015
  %7 = load float, ptr %arrayidx1, align 4, !tbaa !20
  %8 = tail call float @llvm.fmuladd.f32(float %alpha, float %6, float %7)
  store float %8, ptr %arrayidx1, align 4, !tbaa !20
  %y = getelementptr inbounds nuw i8, ptr %arrayidx, i64 4
  %9 = load float, ptr %y, align 4, !tbaa !22
  %y5 = getelementptr inbounds nuw i8, ptr %arrayidx1, i64 4
  %10 = load float, ptr %y5, align 4, !tbaa !22
  %11 = tail call float @llvm.fmuladd.f32(float %alpha, float %9, float %10)
  store float %11, ptr %y5, align 4, !tbaa !22
  %inc = add nuw i64 %i.015, 1
  %exitcond.not = icmp eq i64 %inc, %n
  br i1 %exitcond.not, label %for.cond.cleanup.loopexit.loopexit, label %for.body, !llvm.loop !23
}
