; *** IR Dump After InlinerPass on (axpy_pts_restricted) ***
; Function Attrs: nounwind uwtable
define dso_local void @axpy_pts_restricted(i64 noundef %n, ptr noalias noundef %dst, ptr noalias noundef %src, float noundef %alpha) local_unnamed_addr #3 {
entry:
  br label %for.cond
